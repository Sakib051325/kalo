...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/xylon5005/7R/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            black man 
     \033[1;91m➣ \033[1;92mFACEBOOK   :            black man
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01731787002
     \033[1;96m➣ \033[1;92mGITHUB     :            sakib 
